        ...
        self.tools: dict[str, dict[str, Any]] = {
            ...
            "apply_kicad_route_template": {
                "description": (
                    ...
                    "has, and a schematic difference between channels doesn't get silently papered over. Remove "
                    "existing copper by hand first if you actually want to replace it rather than add alongside "
                    "it. Defaults to write=false (dry run) - inspect "
